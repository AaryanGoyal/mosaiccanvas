...
const testimonials = [
  ...
  {
    quote:
      '"We commissioned a custom piece for our lobby. The artisans in Jaipur corresponded with us at every stage — it felt like a collaboration, not a transaction."',
    author: 'Thomas Larkin',
    role: 'Hospitality Director, The Beaumont, London',
  },
  {
    quote:
      '"Four months later and I still stop to look at it every morning. The light changes the whole composition. I have never owned anything like it."',
    author: 'Ananya Mehta',
    role: 'Collector, Toronto',
  },
]
